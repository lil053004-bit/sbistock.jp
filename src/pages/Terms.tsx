      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-primary">利用規約</h1>
          </div>
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第1条（適用）</h2>
              <p className="text-primary leading-relaxed mb-3">
                本規約は、AI株式診断サービス（以下「当サービス」といいます）の利用に関する条件を、当サービスを利用する全ての方（以下「利用者」といいます）と株式会社集英社インターナショナル（以下「当社」といいます）との間で定めるものです。
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第2条（サービスの内容）</h2>
              <p className="text-primary leading-relaxed mb-3">
              ...
              <ul className="list-disc list-inside text-primary space-y-2 ml-4">
                <li>株式銘柄の基本情報の表示</li>
                <li>株価推移のグラフ表示</li>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第3条（利用上の注意事項）</h2>
              <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-4">
                <p className="text-primary font-semibold mb-2">重要な注意事項</p>
                <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第4条（禁止事項）</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第5条（知的財産権）</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第6条（免責事項）</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第7条（サービスの変更・停止）</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第8条（個人情報の取扱い）</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第9条（規約の変更）</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">第10条（準拠法および管轄裁判所）</h2>
              <p className="text-primary leading-relaxed mb-3">
