        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">1. 基本方針</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">2. 収集する情報</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">3. 情報の利用目的</h2>
              <p className="text-primary leading-relaxed mb-3">
                収集した情報は、以下の目的で利用します：
              </p>
              <ul className="list-disc list-inside text-primary space-y-2 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">4. Google AdSense について</h2>
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-4">
                <p className="text-primary font-semibold mb-2">第三者配信事業者による広告配信</p>
                <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">5. Cookie の使用について</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">6. 第三者への情報提供</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">7. セキュリティ</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">8. 個人情報の開示・訂正・削除</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">9. 未成年者の利用</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">10. プライバシーポリシーの変更</h2>
              <p className="text-primary leading-relaxed">
