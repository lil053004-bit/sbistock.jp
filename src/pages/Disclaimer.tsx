      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-primary">免責事項</h1>
          </div>
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">1. サービスの性質について</h2>
              ...
              <p className="text-primary leading-relaxed mt-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">2. 情報の正確性について</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">3. 投資リスクについて</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">4. 投資判断の責任</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">5. サービスの可用性</h2>
              <p className="text-primary leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">6. 外部リンクについて</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">7. 専門家への相談</h2>
              <p className="text-primary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-primary mb-4">8. 本免責事項の変更</h2>
              <p className="text-primary leading-relaxed">
